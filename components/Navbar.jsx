            ...
            <div className="py-4 flex flex-col">
              ...
              <div className="pt-40 ">
                ...
                <div className="flex items-center justify-between my-4 w-full sm:w-[80%]">
                  ...
                  <a href='https://www.linkedin.com/in/alana-mckeel-web-dev/' target="_blank" rel="noopener noreferrer"><FaLinkedinIn /></a>
                  </div>
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in-duration-300">
                  <a href='https://github.com/alanam79' target="_blank" rel="noopener noreferrer"><FaGithub /></a>
                  </div>
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in-duration-300">
                  <a href="mailto:name@gmail.com"><AiOutlineMail /></a>
                  </div>
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in-duration-300">
                    <BsPersonLinesFill />
                  </div>
